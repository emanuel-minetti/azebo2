...
export default class WorkingDay {
  ...
  constructor(data?: any) {
    if (
      ...
      this._begin = FormatterService.convertToTime(year, monthIndex, day, data.begin);
      this._end = FormatterService.convertToTime(year, monthIndex, day, data.end);
      ...
      this._afternoonBegin = FormatterService.convertToTime(year, monthIndex, day, data.afternoon_begin);
      this._afternoonEnd = FormatterService.convertToTime(year, monthIndex, day, data.afternoon_end);
    } else {
      this._date = new Date();
      this._break = false;
